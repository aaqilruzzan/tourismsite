...
//crating an array and passing the number, questions, options, and answer
let questions=[
  {
    numb:1,
  ...
  {
    numb:4,
    question:"What is the name of the famous waterfall in Brazil?",
    answer:"Iguazu Falls",
    options:[
      "Victoria Falls",
      "Iguazu Falls",
  ...
  {
    numb:8,
    question:"Which African country is known for its wildlife safaris?",
    answer:"Kenya",
    options:[
      "Kenya",
      "Ghana",
  ...
  {
    numb:10,
    question:"Which country is known for its colorful tulip fields?",
    answer:"Netherlands",
    options:[
      "Austria",
      "Denmark",
